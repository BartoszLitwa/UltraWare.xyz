...
public:
	...
	NETVAR(int32_t, m_zoomLevel, "DT_BaseCombatWeapon", "m_zoomLevel");
...
public:
	...
	void C_BasePlayer::SetAbsOrigin(const Vector& origin)
	{
		...
		static SetAbsOriginFn SetAbsOrigin = (SetAbsOriginFn)Utils::PatternScan(GetModuleHandleA("client_panorama.dll"), "55 8B EC 83 E4 F8 51 53 56 57 8B F1 E8"); //"E8 ?? ?? EB 19 8B 07" + 1
	...
	void C_BasePlayer::SetAbsAngles(const QAngle& angles)
	{
		...
		static SetAbsAnglesFn SetAbsAngles = (SetAbsAnglesFn)Utils::PatternScan(GetModuleHandleA("client_panorama.dll"), "55 8B EC 83 E4 F8 83 EC 64 53 56 57 8B F1 E8"); //"55 89 E5 53 57 56 81 EC AC 00 00 00 8B 75 08 8B 5D 0C "
...
public:
	...
	NETVAR(int32_t, m_nWorldModelIndex, "DT_BaseViewModel", "m_nWorldModelIndex");
...
public:
	...
	char pad9[4]; //NaN
	float m_flUnknown3; //0x12C
	char pad10[104];
	float animstate0x334; //0x334
	char pad11[420]; //528
}; //Size=0x344
