...
public:
	...
	//{
		//return CallVFunction<IMatRenderContext*>(this, 115);
	//}

	//IMaterial* CreateMaterial(const char* mat_name, KeyValues* vmt_key_vals)
	//{
		//return CallVFunction< IMaterial*(__thiscall*)(void*, const char*, KeyValues*)>(this, 83)(this, mat_name, vmt_key_vals);
	//}

	//IMaterial* FindMaterial(const char* pMaterialName, const char* pTextureGroupName)
	//{
		//return CallVFunction<IMaterial* (__thiscall*)(void*, const char*, const char*)>(this, 84)(this, pMaterialName, pTextureGroupName);
	//}

	/*MaterialHandle_t FirstMaterial()
	{
		return CallVFunction<MaterialHandle_t>(this, 86);
	}

	MaterialHandle_t NextMaterial(MaterialHandle_t handle)
	{
		return CallVFunction< MaterialHandle_t(__thiscall*)(void*, MaterialHandle_t)>(this, 87)(this, handle);
	}

	MaterialHandle_t InvalidMaterial()
	{
		return CallVFunction< MaterialHandle_t>(this, 88);
	}
	IMaterial* GetMaterial(MaterialHandle_t handle)
	{
		return CallVFunction< IMaterial * (__thiscall*)(void*, MaterialHandle_t)>(this, 89)(this, handle);
	}*/
	...
	virtual MaterialHandle_t                test() const = 0;
